      ...
      <section className="section bg-neutral-50 dark:bg-neutral-900/50" aria-labelledby="why-heading">
        <div className="container">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Award, title: "Uniform Quality", desc: "All categories manufactured to same WHO GMP standards" },
              { icon: Shield, title: "Regulatory Ready", desc: "Comprehensive documentation for global registrations" },
              ...
              { icon: Users, title: "Clinical Support", desc: "Medical affairs support for all therapeutic areas" },
              { icon: Shield, title: "Pharmacovigilance", desc: "Integrated safety monitoring for all products" },
              { icon: Cpu, title: "Digital Tracking", desc: "Serialization and traceability on every unit" },
              { icon: Award, title: "Continuous Improvement", desc: "Ongoing R&D for formulation optimization" },
            ].map((item, index) => (
