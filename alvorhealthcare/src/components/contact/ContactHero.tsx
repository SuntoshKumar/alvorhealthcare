...
export function ContactHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-primary-50 via-white to-teal-50 dark:from-primary-950/35 dark:via-neutral-950 dark:to-teal-950/25 py-16 lg:py-24" aria-labelledby="contact-heading">
      {/* Background patterns */}
              ...
              <div className="relative">
                ...
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex -space-x-2">
                    {["bg-primary-500", "bg-emerald-500", "bg-teal-500"].map((color, i) => (
                      <div
                        key={i}
