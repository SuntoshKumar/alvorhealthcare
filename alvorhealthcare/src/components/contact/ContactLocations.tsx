            ...
            return (
              ...
              >
                <a
                  ...
                  className="pharma-card group flex h-full flex-col rounded-2xl border border-neutral-100 bg-white p-6 transition-[border-color,box-shadow,transform] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-4 dark:border-neutral-700/50 dark:bg-neutral-800/30 dark:focus-visible:ring-offset-neutral-950 lg:p-7"
                >
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center flex-shrink-0 shadow-md transition-transform duration-300 group-hover:scale-105">
                  ...
                  <div>
                    ...
                    <p className="text-primary-600 dark:text-primary-400 text-xs font-semibold uppercase tracking-wider mt-1">
                      {office.city}
                    </p>
                  ...
                  <span className="mt-6 flex items-center gap-2 border-t border-neutral-100 pt-4 text-sm font-semibold text-primary-700 opacity-0 transition-opacity duration-200 group-hover:opacity-100 dark:border-neutral-700 dark:text-primary-300">
