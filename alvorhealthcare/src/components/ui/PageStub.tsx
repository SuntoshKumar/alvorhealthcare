  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center bg-white dark:bg-neutral-950">
      <div className="container max-w-2xl text-center px-6">
        <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-primary-50 dark:bg-primary-900/30 flex items-center justify-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-6 py-3 bg-primary-600 dark:bg-primary-700 text-white rounded-xl font-semibold hover:bg-primary-700 dark:hover:bg-primary-600 transition-colors"
        >
